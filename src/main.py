...
def PeopleCounter(cap,w,h,areaTH):
...
if __name__ == "__main__":
	...
	if args["source"]=="ipcamera":
		print("[INFO] streaming the video  from "+ args['file_in'])
		cap = cv2.VideoCapture(args['file_in'])
	...
	if cap != None:
		...
		while(cap.isOpened()):
			...
			PeopleCounter(cap,w=w,h=h,areaTH=areaTH)
